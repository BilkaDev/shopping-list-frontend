...
import { Button, FormControl, FormErrorMessage, Input, Stack, VStack } from "@chakra-ui/react";
...
export function RecoverForm() {
    ...
    return (
        <>
            ...
            {isSuccess &&
                <InfoModal message={"If e-mail is used then password has been sent"} onClose={closeSucessModalHandler}
                           title={"Success!"}/>}
